...
![拾忆今日复习界面](pics/今日复习.png)
交流意见：
邮箱：3358442371@qq.com WeChat:yeen_123456
## 快速使用
...
<details>
<summary><strong>记忆与复习闭环</strong>：日历、内容库与直播课复习</summary>

| 复习日历 | 记忆内容库 |
| --- | --- |
| ![按日期查看复习任务](pics/复习日历.png) | ![按分类管理记忆内容](pics/记忆内容.png) |

![直播课复习表](pics/直播课复习.png)

</details>

<details>
<summary><strong>AI 整理与知识沉淀</strong>：资料识别、错题、词语和常识政治</summary>

| AI 整理台 | 按试卷归档的错题库 |
| --- | --- |
| ![AI 整理台及用量统计](pics/AI整合台.png) | ![按地区年份和试卷整理错题](pics/错题库（按地区、年份、卷分）.png) |

| 成语词语与知识图谱 | 常识与政治知识库 |
| --- | --- |
| ![成语词语积累与知识图谱](pics/成语词语.png) | ![常识与政治知识积累](pics/常识政治.png) |

</details>

<details>
<summary><strong>专注与认知训练</strong>：番茄钟、N-Back、舒尔特方格和序列相加</summary>

| 番茄专注 | 工作记忆训练 |
| --- | --- |
| ![番茄钟与专注统计](pics/番茄专注.png) | ![三种工作记忆训练及成绩](pics/工作记忆.png) |

</details>

<details>
<summary><strong>花生 800 词</strong>：词簇图谱、故事联想与主动回忆卡片</summary>

![花生 800 词知识图谱及词语编辑](pics/花生800.png)

| 先尝试主动回忆 | 揭示答案并评价掌握程度 |
| --- | --- |
| ![词语记忆卡片回忆阶段](pics/回忆卡片1.png) | ![词语记忆卡片答案阶段](pics/回忆卡片2.png) |
